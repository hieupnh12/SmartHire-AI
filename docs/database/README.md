...
| Số file migration đang chạy | **36** (20 master + 16 tenant V1–V16) |
| Cập nhật lần cuối | Master `V21`, tenant `V16`; V9 analytics nằm lại trong pipeline, `job_assignments` là V16 |
