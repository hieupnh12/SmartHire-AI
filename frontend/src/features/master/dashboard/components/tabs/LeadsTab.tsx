...
import { ConsultationResponse } from "@/api/master/consultationApi";
import { useMasterDashboard } from "../../context/MasterDashboardContext";

interface LeadsTabProps {
  handleOpenCreateContractForLead: (lead: ConsultationResponse) => void;
  handleOpenLeadModal: (lead: ConsultationResponse) => void;
}

export function LeadsTab({ handleOpenCreateContractForLead, handleOpenLeadModal }: LeadsTabProps) {
  const navigate = useNavigate();
  const { leads } = useMasterDashboard();
