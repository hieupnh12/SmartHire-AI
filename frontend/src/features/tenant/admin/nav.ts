...
export const adminNav = [
  ...
  { to: "/roles", labelKey: "nav.rolesPermissions", icon: ShieldCheck, comingSoon: true, groupId: "people", groupLabelKey: "nav.adminPeople", groupDescriptionKey: "nav.adminPeopleDescription", groupIcon: Users },
  { to: "/recruiter-assignments", labelKey: "nav.recruiterAssignments", icon: UserRoundCog, comingSoon: true, groupId: "people", groupLabelKey: "nav.adminPeople", groupDescriptionKey: "nav.adminPeopleDescription", groupIcon: Users },
  ...
  { to: "/analytics", labelKey: "nav.recruitmentAnalytics", icon: ChartNoAxesCombined, comingSoon: true, groupId: "recruitment", groupLabelKey: "nav.adminRecruitment", groupDescriptionKey: "nav.adminRecruitmentDescription", groupIcon: GitBranch },
