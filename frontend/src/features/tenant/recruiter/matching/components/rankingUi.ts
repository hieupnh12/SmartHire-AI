...
export const primary = `${button} bg-[var(--color-primary-container)] text-[var(--color-on-primary)] hover:bg-[var(--color-primary-container)]`;
...
export const labels: Record<string, string> = {
  ...
  SELECT_SOURCE: "Cần chọn nguồn", NEEDS_REVIEW: "Cần xác minh", NEW: "Mới ứng tuyển", IN_REVIEW: "Đang xem xét",
  ASSESSMENT: "Assessment", INTERVIEW: "Phỏng vấn", OFFER: "Đề nghị", HIRED: "Đã tuyển", REJECTED: "Đã từ chối", WITHDRAWN: "Đã rút",
};
