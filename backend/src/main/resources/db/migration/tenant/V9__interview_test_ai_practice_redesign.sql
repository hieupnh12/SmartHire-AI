-- V9: Align Interview / Test / AI Interview / Practice entities with ER redesign.
-- Destructive reshape for early-stage schema (demo data may be cleared).
...
-- ---------------------------------------------------------------------------
-- 2) Drop obsolete AI-interview child tables (data moved conceptually to ai_*)
-- ---------------------------------------------------------------------------
DROP TABLE IF EXISTS interview_answer_analyses;
...
-- ---------------------------------------------------------------------------
-- 3) Drop assessment scoring / attempt children that will be rebuilt
-- ---------------------------------------------------------------------------
...
ALTER TABLE ranking_sources
    CHANGE COLUMN attempt_id submission_id BIGINT NULL,
    CHANGE COLUMN interview_id ai_interview_id BIGINT NULL;

UPDATE ranking_sources SET submission_id = NULL, ai_interview_id = NULL;
