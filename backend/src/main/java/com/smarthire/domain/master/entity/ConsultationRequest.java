...
public class ConsultationRequest {
    ...
    @Column(name = "company_name", nullable = false) String companyName;
    ...
    @Column(name = "plan_tier") String planTier;
    @Column(name = "primary_need", columnDefinition = "TEXT") String primaryNeed;
